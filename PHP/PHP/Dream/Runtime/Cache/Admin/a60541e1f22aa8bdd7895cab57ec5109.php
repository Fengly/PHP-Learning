<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><html><head><meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8" content="ie=edge" /><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>Dream缺陷跟踪系统 - <?php echo C('CFG_NAME') ?></title><script type="text/javascript" src="__ITEM__/__UI__/jquery.js"></script><script type="text/javascript" src="__ITEM__/__JS__/jquery.cookie.js"></script><script language="javascript"> var isskin = $.cookie('easyui')?$.cookie('easyui'):'default';
 ...
 $(function(){
 ...
 </script></head><body id="layoutBody" class="easyui-layout"><div class="top" id="topBg" data-options="region:'north',border:false"><script language="javascript">$(function(){
  ...
  </script><div class="show"><div class="l2"><span id="localtime" style="margin-right:18px"></span><a href="#" style="margin-right:2px;" id="chgSkin" title="切换皮肤"><img src="__ITEM__/__IMG__/skin.png" /></a><span class="hi">您好：<strong><?php echo $_SESSION['login']['se_user'] ?></strong> 您有<span id="smsid" class="margin_lr bgcolor_bolck bgcolor_cs" style="cursor:pointer;" onclick="toShowSms()"></span>条通知 - <?php echo $_SESSION['login']['se_group'] ?> &nbsp;[<a href="javascript:toSendMail();">发邮件</a>] <?php if($group_access>=9999){ ?>[<a href="javascript:toClearCache();">清除缓存</a>]<?php } ?> [<a href="javascript:toRepwd();">修改密码</a>] [<a href="javascript:toSetpwd();">邮箱设置</a>] [<a target="_top" href="__APP__?g=<?php echo GROUP_NAME; ?>&m=Index&a=safe">注销</a>] [<a href="http://www.d-winner.com/html/api/WinnerApi/" target="_blank">帮助</a>]</span></div></div><script runat="server" language="javascript">function tick(){  
    var today;  
    today = new Date();
