...
document.zhuce.ICO.options[document.zhuce.ICO.selectedIndex].value;
              ...
              <tr>
				...
				<td><select size="1" name="ICO" onChange="showlogo()">
                      ...
                      <option value="11.gif">头像11
                      <option value="12.gif">头像12
                      <option value="10.gif">头像13
                  </select></td>
              </tr>
            </table></td>
          </tr>
          ...
          <tr>
            ...
            <td class="style2">
                <input name="qrtj" type="submit" id="qrtj" value="确认提交">
                <input type="reset" name="Submit2" value="刷新重置">
            </td>
          </tr>
		  </form>
        </table>
